...
var loader = function loader2(css) {
  ...
  const _a = options != null ? options : {}, { specifier, tag, uglify } = _a, rest = __objRest(_a, ["specifier", "tag", "uglify"]);
  transform(__spreadValues({ css, specifier, tag, uglify, filePath }, rest)).then((result) => {
