    ...
    return html`
      <div class="ds-container pokecard-body ${classMap(this.hasPokemonClass)}">
        <div class="ds-flex">
          ...
          <div
            class="pokecard-stats ds-col__12-s ds-col__5-l ${classMap({
              isnotvisible:
                Array.isArray(this.encounters) && !this.encounters.length,
            })}">
            ${when(
              Array.isArray(this.encounters) && this.encounters.length > 0,
