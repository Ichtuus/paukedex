...
export class Store {
    ...
    put(data: object, storename: string, mode: IDBTransactionMode, key: number): Promise<any>  {
        return this.handleTransaction(typeTransactionE.PUT, mode, storename, data, key)
    }

    delete(data: number, storename: string, mode: IDBTransactionMode): Promise<any>  {
        return this.handleTransaction(typeTransactionE.DELETE, mode, storename, data)
    }
    ...
    handleTransaction(type: typeTransactionE, mode: IDBTransactionMode, storename: string, data?: any, key?: number) {
        console.log('type', type, 'mode', mode, 'storename', storename, 'data', data, 'key', key)
        return new Promise((resolve, reject) => {
