...
export function frToEnPokemonName(name: string) {
	if (name) {
		return POKEMON_NAME.find(
			(needed) => needed.fr === capitalizeFirstLetter(name)
		)?.en
	}
}
...
export function enToFrPokemonName(name: string) {
	if (name) {
		return POKEMON_NAME.find(
			(needed) => needed.en === capitalizeFirstLetter(name)
		)?.fr
	}
}
...
export const POKEMON_NAME = [
	...
	{ en: 'Nidoran-f', fr: 'Nidoran-f' },
	{ en: 'Nidorina', fr: 'Nidorina' },
	{ en: 'Nidoqueen', fr: 'Nidoqueen' },
	{ en: 'Nidoran-m', fr: 'Nidoran-m' },
	...
	{ en: 'Magneton', fr: 'Magnéton' },
	{ en: "Farfetchd", fr: 'Canarticho' },
	{ en: 'Doduo', fr: 'Doduo' },
	{ en: 'Dodrio', fr: 'Dodrio' },
	{ en: 'Seel', fr: 'Otaria' },
