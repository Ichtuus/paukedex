  ...
  getPokemonMoveDetail() {
    if (this.hasMoves()) {
      ...
      if (this.selectElement) {
        ...
        return html`
          <ul>
            <li title="name: ${this.currentMoove.name}">
              ${this.currentMoove.name}
            </li>
            <li title="accuracy: ${this.currentMoove.accuracy}">
              ${this.currentMoove.accuracy}
            </li>
            <li title="damage class: ${this.currentMoove.damage_class.name}">
              ${this.currentMoove.damage_class.name}
            </li>
            <li
              title="attack description: ${this.arrayMethodFilterBylang(
            ...
            <li title="power: ${this.currentMoove.power}">
              ${this.currentMoove.power}
            </li>
